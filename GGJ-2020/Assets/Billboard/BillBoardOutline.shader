...
Shader "Sprites/OutlineBillboard"
{
    Properties
    {
		...
		tintColor("Tint Colour", Color) = (0, 0, 0, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            vertexOutput.pos = mul(UNITY_MATRIX_P, 
              mul(UNITY_MATRIX_MV, float4(0.0, 0.0, 0.0, 1.0))
              + float4(vertexInput, vertexInput, 0.0, 0.0)
              * float4(_ScaleX, _ScaleY, 1.0, 1.0));
 
            vertexOutput.tex = vertexInput.tex;
            ...
            fixed4 ComputeFragment(VertexOutput vertexOutput) : SV_Target
            {
                ...
                color.rgb = lerp(color.rgb, _OutlineColor.rgb * _OutlineColor.a, shouldDrawOutline);
                 ...
                 return tintColor * tex2D(_MainTex, float2(vertexOutput.tex.xy));
            }
